...
namespace AloKaza.Data.Migrations
{
    ...
    [Migration("20230621131931_AppLogs_edited")]
    partial class AppLogs_edited
    {
            ...
            modelBuilder.Entity("AloKaza.Core.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 6, 21, 16, 19, 31, 557, DateTimeKind.Local).AddTicks(8983),
                            ...
                            Password = "123",
                            Phone = "5448504624",
                            UserGuid = new Guid("22cff2a5-87b4-49a1-893f-db1929617bef")
                        });
                });

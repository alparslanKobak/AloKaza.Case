        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlnDetail = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAnyCriminal = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Damages_Reports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "CreateDate", "Email", "FullName", "Image", "IsActive", "IsAdmin", "IsCorporate", "Password", "Phone", "UserGuid" },
                values: new object[] { 1, new DateTime(2023, 6, 21, 15, 38, 25, 469, DateTimeKind.Local).AddTicks(3831), "info@AloKaza.com", "Admin", null, true, true, false, "123", "5448504624", new Guid("8628ad4c-19a5-4ff1-87d1-a95dfae3c7a3") });

            migrationBuilder.InsertData(
                table: "Settings",
                columns: new[] { "Id", "Address", "Description", "Email", "Favicon", "Logo", "MailServer", "MapCode", "Password", "Phone", "Port", "Title", "UserName" },
                values: new object[] { 1, "Adres", null, "yazilim@AloKaza.com", null, null, null, null, null, null, 587, "AloKazaCase", null });

            migrationBuilder.CreateIndex(
                name: "IX_Damages_ReportId",
                table: "Damages",
                column: "ReportId");
